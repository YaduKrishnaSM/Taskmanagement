...
public class TestListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		WebDriver webDriver = utilities.CommonMethod.getDriver();
		...
		//ExtentTestManager.getTest().log(Status.INFO,"Error Screenshot 2", MediaEntityBuilder.createScreenCaptureFromPath(base64Screenshot).build());
	}
